...
<div class="col-xs-4 col-md-3 col-sm-2 col-lg-1">
<label for="pseudo" class="col-2 col-form-label"> Pseudo : </label>
			<%-- traitement ifEmpty  à faire --%>
			<input class="form-controln col-2" type="text" id="pseudo"
			...
			<%-- traitement ifEmpty  à faire --%>
			<input class="form-controln col-2" type="text" id="nom" name="nom"
				value="${param.nom}" required="required" placeholder=" Votre nom ?">
				<label for="telephone" class="col-2 col-form-label">
				Téléphone : </label>
			<%-- traitement if not conform à faire --%>
			<input class="form-controln col-2" type="text" id="telephone"
				name="telephone" value="${param.telephone}"required="required" placeholder="Votre numero de téléphone ?"> <label
				for="rue" class="col-2 col-form-label"> Rue : </label>
			<%-- traitement if empty  à faire --%>
			<input class="form-controln col-2" type="text" id="rue" name="rue"
				value="${param.rue}"required="required" placeholder=" rue :">
				<label for="motDePasse1" class="col-2 col-form-label"> Mot de
				Passe : </label>
			<%-- traitement if not conform à faire --%>
			<input class="form-controln col-2" type="password" id="motDePasse1"
				name="motDePasse1" required="required" placeholder=" choisissez un mot de passe :"> <label for="motDePasse"
				class="col-2 col-form-label"> Confirmer : </label>
			<%-- traitement if = motDePasse1  à faire --%>
			<input class="form-controln col-2" type="password" id="motDePasse"
				name="motDePasse" value="${param.motDePasse}" required="required" placeholder=" saisissez de nouveau le mot de passe :">
</div>

<div class="col-xs-4 col-md-3 col-sm-2 col-lg-1">
<label for="prenom" class="col-2 col-form-label"> Prénom : </label>
			<%-- traitement ifEmpty à faire --%>
			<input class="form-controln col-2" type="text" id="prenom"
			...
			<input class="form-controln col-2" type="email" size = "50" id="email"
...
<label for="codePostal" class="col-2 col-form-label"> Code
				Postal : </label>
			<%-- traitement if not conform à faire --%>
			<input class="form-controln col-2" type="text" id="codePostal"
				name="codePostal" value="${param.codePostal}"required="required" placeholder=" codePostal:"> <label
				for="ville" class="col-2 col-form-label"> Ville : </label>
			<%-- traitement if empty  à faire --%>
			<input class="form-controln col-2" type="text" id="ville"
