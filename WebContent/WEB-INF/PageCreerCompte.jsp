		...
		<form method="post" action="${pageContext.request.contextPath}/CreerCompte" class="form-horizontal">
			<div class="saisie row my-2">
				...
				<input class="form-controln col-3" type="text" id="pseudo"
					...
					autofocus="autofocus" placeholder="Votre pseudo ?"> <label
					for="nom" class="col-3 col-form-label"> Nom : </label>
			...
			<div class="row my-2">
				...
				<input class="form-controln col-3" type="text" id="prenom"
					...
					placeholder="Votre prénom ?"> <label for="email"
			...
			<div class="row my-2">
				...
				<input class="form-controln col-3" type="text" id="telephone"
					name="telephone" value="${param.telephone}" required="required"
					placeholder="Votre numero de téléphone ?"> <label for="rue"
					class="col-3 col-form-label"> Rue : </label>
			...
			<div class="row my-2">
				...
				<input class="form-controln col-3" type="text" id="codePostal"
					...
					placeholder=" codePostal:"> <label for="ville"
					class="col-3 col-form-label"> Ville : </label>
				<%-- traitement if empty  à faire --%>
			...
			<div class="row my-2">
				<label for="motDePasse1" class="col-3 col-form-label"> Mot
					de Passe : </label>
				<%-- traitement if not conform à faire --%>
				<input class="form-controln col-3" type="password" id="motDePasse1"
					name="motDePasse1" required="required"
					placeholder=" choisissez un mot de passe :"> <label
					for="motDePasse" class="col-3 col-form-label"> Confirmer :
				</label>
