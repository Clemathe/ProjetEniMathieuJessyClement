...
public class ArticleVenduDAOJdbcImpl implements ArticleVenduDAO {
	...
	public List<ArticleVendu> getenchereEnCours(String categorie, String nomArticlePartiel) {
		...
		String ENCHERES_EN_COURS =
				...
				+ "WHERE no_article = (SELECT no_article FROM ARTICLES_VENDUS "
									+ "JOIN CATEGORIES ON ARTICLES_VENDUS.no_categorie = CATEGORIES.no_categorie WHERE libelle = "+categorie;
